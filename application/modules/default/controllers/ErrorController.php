    ...
    public function errorAction()
    {
        ...
        switch ($errors->type) {
            ...
            case Zend_Controller_Plugin_ErrorHandler::EXCEPTION_NO_ACTION:
                ...
                $this->view->message = 'Message : '.$errors->exception->getMessage() . PHP_EOL . 'Request Prameter : ' . var_export($errors->request->getParams(), true) . PHP_EOL . "Stack Trace :" .$errors->exception->getTraceAsString();
                break;
            default:
                // application error
